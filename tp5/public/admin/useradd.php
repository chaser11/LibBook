...
<script src="inc/adduser.js"></script>
</head>
<script>
		...
		<ul>
			...
			<li><!--  class="current" -->
				...
				<ul class="child">
					...
					<li><a  class="current" href="useradd.php">添加用户</a></li>
			...
			<li>
				...
				<ul class="child">
					...
					<li><a href="seatclear.php">清空座位</a></li>				</ul>
			</li>
		</ul>
	</div>
...
<li>|- 内存限制：128M</li>
		...
		<input class="btn" onclick=get() type="submit" name="submit" value="添加" />
